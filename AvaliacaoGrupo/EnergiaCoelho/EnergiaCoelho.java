...
public class EnergiaCoelho {
	...
	static void listarFaturasAbertas() {
		...
		for (Fatura fatura : faturas) {
			if (!fatura.quitada) {
				System.out.println("Matrícula: " + fatura.imovel.getMatricula());
				System.out.println("Valor: " + fatura.valorCalculado);
				System.out.println("Data de Emissão: " + fatura.dataEmissao);
				System.out.println("Quitada: " + fatura.quitada);
				System.out.println("------");
			}
		}
	}
